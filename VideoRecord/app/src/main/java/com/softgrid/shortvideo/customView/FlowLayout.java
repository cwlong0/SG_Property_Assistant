...
public class FlowLayout extends RelativeLayout {
    ...
    // 水平间距，单位为dp
    private int horizontalSpacing = dp2px(6);
    // 竖直间距，单位为dp
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.FlowLayoutAttrs_horizontalSpacing) {
                horizontalSpacing = typedArray.getDimensionPixelSize(attr, horizontalSpacing);

            } else if (attr == R.styleable.FlowLayoutAttrs_verticalSpacing) {
                verticalSpacing = typedArray.getDimensionPixelSize(attr, verticalSpacing);
                ...
                textPaddingH = typedArray.getDimensionPixelSize(attr, textPaddingH);
    ...
    public void setFlowLayout(List<String> list, final OnItemClickListener onItemClickListener) {
        ...
        if (textViews.size() != 0){
            for (int i = 0; i < textViews.size(); i++){
                this.removeView(textViews.get(i));
            }
            textViews.clear();
        }
