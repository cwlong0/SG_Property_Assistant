...
public class FileOperateUtil {
	...
	private final static String videoPathName = "video";
	private final static String thumbPathName = "thumb";
	...
	public static String getFolderPath(Context context,int type) {
		...
		switch (type) {
			case TYPE_IMAGE:
				pathBuilder.append(imagePathName);
				break;
			case TYPE_VIDEO:
				pathBuilder.append(videoPathName);
				break;
			case TYPE_THUMBNAIL:
				pathBuilder.append(thumbPathName);
				break;
			default:
				break;
		}
	...
	public static boolean deleteThumbFile(String thumbPath,Context context) {
		...
		flag = file.delete();
		//源文件路径
		String sourcePath=thumbPath.replace(thumbPathName,
				imagePathName);
	...
	public static boolean deleteSourceFile(String sourcePath,Context context) {
		...
		flag = file.delete();
		//缩略图文件路径
		String thumbPath=sourcePath.replace(imagePathName,
				thumbPathName);
